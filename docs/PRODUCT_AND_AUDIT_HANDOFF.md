...
- Active upcoming signed/public drop: Rekt Tradooor, `0x7b3EcFA33657De415Ff269dC97dfa82954cEe706`, OpenSea slug `rekt-tradooor`, Robinhood Chain. The verified `ERC721SeaDrop` contract was deployed with the standard reviewed SeaDrop `0x00005EA00Ac477B1030CE78506496e8C2dE24bf5`, has a 10,000 maximum supply and zero minted at Robinhood block 40,971,434. OpenSea exposes three one-per-wallet stages at exactly 0.02 ETH: signed `Phase 1` from 2026-08-21 16:00–17:00 UTC (stage index 1), signed `Phase 2` from 17:00–18:00 UTC (stage index 2), then public from 18:00 UTC through 2026-08-22 18:00 UTC. On-chain public configuration independently matches the public time, price, cap, 1,000 fee bps and restricted OpenSea fee recipient. The registered signer validation bounds require exactly 1,000 fee bps, allow the reviewed times/price/one-wallet cap, and cap a signed stage at the 10,000 collection supply. Signed phases remain wallet-specific and must obtain a fresh OpenSea payload; any different payload field fails closed.
